  ...
  return (
    <div className="md:col-span-3">
      ...
      <section className="container mx-auto my-5">
        <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 text-cyan-300 rounded-2xl text-center p-4 font-bold text-2xl">
